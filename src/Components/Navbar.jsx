...
const Navbar = () => {
  ...
  return (
    <nav className="px-2 py-1  bg-cofee_dark fixed top-0 w-full z-50">
      <div className="container mx-auto flex justify-between items-center">
        ...
        <div className="flex items-center space-x-3 lg:hidden">
          <button onClick={toggleMenu}>
            <FontAwesomeIcon
              icon={faBars}
              className="text-cofee_ligt text-3xl"
            />
          </button>
          <button onClick={handleLogIn}>
            <FontAwesomeIcon
              icon={faUser}
              className="text-cofee_ligt text-2xl"
            />
          </button>
        </div>
        ...
        <div className="hidden lg:flex">
          <button
            className="text-xl hover:text-cofee_dark hover:bg-cofee font-bold py-1 px-2 border border-cofee rounded-3xl text-cofee_ligt"
            onClick={handleLogIn}
          >
            Log In
          </button>
