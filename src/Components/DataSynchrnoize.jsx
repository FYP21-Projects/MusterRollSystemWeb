      ...
      <div className="flex flex-col justify-around md:flex-row w-full max-w-6xl">
        ...
        <div className="flex flex-col justify-around items-center text-center md:w-1/2 p-8">
          ...
          <p className="text-gray-700 text-2xl">
            MRS automatically syncs attendance data once you're connected,
            sending locally saved records to the server. This keeps your records
            updated and removes the need for manual data entry.
          </p>
        </div>
        {/* Left Div */}
